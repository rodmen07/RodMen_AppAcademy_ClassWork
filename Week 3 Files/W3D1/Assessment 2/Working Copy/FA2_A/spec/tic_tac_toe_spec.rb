...
describe "TicTacToe" do
    ...
    before(:each) { allow_message_expectations_on_nil }

    describe "#initialize" do
        it "should accept an optional integer as an argument representing a `size`" do
            expect(TicTacToe.instance_method(:initialize).parameters[0][0]).to eq(:opt)
        end
